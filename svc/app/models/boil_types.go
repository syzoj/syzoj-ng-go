...
// Enum values for judge_state.status are not proper Go identifiers, cannot emit constants
// Enum values for problem.type are not proper Go identifiers, cannot emit constants
// Enum values for submission_statistics.type
const (
