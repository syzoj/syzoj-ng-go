...
var (
	userDBTypes = map[string]string{`ID`: `int`, `Username`: `varchar`, `Email`: `varchar`, `Password`: `varchar`, `Nickname`: `varchar`, `Nameplate`: `text`, `Information`: `text`, `AcNum`: `int`, `SubmitNum`: `int`, `IsAdmin`: `tinyint`, `IsShow`: `tinyint`, `PublicEmail`: `tinyint`, `PreferFormattedCode`: `tinyint`, `Sex`: `int`, `Rating`: `int`, `RegisterTime`: `int`}
	_           = bytes.MinRead
)
