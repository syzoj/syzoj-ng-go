...
type User struct {
	...
	PreferFormattedCode null.Int8   `boil:"prefer_formatted_code" json:"prefer_formatted_code,omitempty" toml:"prefer_formatted_code" yaml:"prefer_formatted_code,omitempty"`
...
var UserWhere = struct {
	...
	Nameplate:           whereHelpernull_String{field: "`user`.`nameplate`"},
	Information:         whereHelpernull_String{field: "`user`.`information`"},
	AcNum:               whereHelpernull_Int{field: "`user`.`ac_num`"},
	SubmitNum:           whereHelpernull_Int{field: "`user`.`submit_num`"},
	IsAdmin:             whereHelpernull_Int8{field: "`user`.`is_admin`"},
	IsShow:              whereHelpernull_Int8{field: "`user`.`is_show`"},
	PublicEmail:         whereHelpernull_Int8{field: "`user`.`public_email`"},
	PreferFormattedCode: whereHelpernull_Int8{field: "`user`.`prefer_formatted_code`"},
	Sex:                 whereHelpernull_Int{field: "`user`.`sex`"},
	Rating:              whereHelpernull_Int{field: "`user`.`rating`"},
	RegisterTime:        whereHelpernull_Int{field: "`user`.`register_time`"},
}
...
var (
	userAllColumns            = []string{"id", "username", "email", "password", "nickname", "nameplate", "information", "ac_num", "submit_num", "is_admin", "is_show", "public_email", "prefer_formatted_code", "sex", "rating", "register_time"}
	userColumnsWithoutDefault = []string{"username", "email", "password", "nickname", "nameplate", "information", "ac_num", "submit_num", "is_admin", "is_show", "sex", "rating", "register_time"}
	userColumnsWithDefault    = []string{"id", "public_email", "prefer_formatted_code"}
