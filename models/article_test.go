...
var (
	articleDBTypes = map[string]string{`ID`: `int`, `Title`: `varchar`, `Content`: `mediumtext`, `UserID`: `int`, `ProblemID`: `int`, `PublicTime`: `int`, `UpdateTime`: `int`, `SortTime`: `int`, `CommentsNum`: `int`, `AllowComment`: `tinyint`, `IsNotice`: `tinyint`}
	_              = bytes.MinRead
)
